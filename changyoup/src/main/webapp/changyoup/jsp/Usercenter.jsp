...
<head>
    ...
    <link rel="stylesheet" href="../Usercenter/font-awesome-4.6.3/css/font-awesome.min.css">           <!-- Font Awesome, http://fontawesome.io/ -->
    <link rel="stylesheet" href="../Usercenter/css/bootstrap.min.css">                                 <!-- Bootstrap style, http://v4-alpha.getbootstrap.com/ -->
    <link rel="stylesheet" href="../Usercenter/css/magnific-popup.css">                                <!-- Magnific pop up style, http://dimsemenov.com/plugins/magnific-popup/ -->
    <link rel="stylesheet" href="../Usercenter/css/templatemo-style.css">                              <!-- Templatemo style -->
	...
	<div class="container-fluid">
		...
		<section id="welcome" class="tm-content-box tm-banner margin-b-10">
			<div class="tm-banner-inner">
				<h1 class="tm-banner-title">UserCenter</h1>                        
			</div>                    
		</section>
            ...
            <div class="tm-body">
                ...
                <div class="tm-main-content">
                    ...
                    <div class="tm-content-box tm-content-box-home">                        
                        <img src="../Usercenter/img/1200x800-01.jpg" alt="Image 1" class="img-fluid tm-welcome-img">                        
                        <div class="tm-welcome-boxes-container">
                            <div class="tm-welcome-box">
                                <div class="tm-welcome-text">
                                    <h2 class="tm-section-title">UserInfo</h2>
									...
									<tbody>
										...
										<tr>
											...
											<td class="userinfo" id="email"><%=userinfo.getEmail()%></td>
											<td class="userinfo" id="area"><%=userinfo.getArea()%></td>
                                ...
                                <a href="#" class="tm-welcome-link tm-button">Double Click to Change</a>
                            </div>
                            <div class="tm-welcome-box">
                                <div class="tm-welcome-text">
                    ...
                    <div id="gallery" class="tm-content-box">                        
                        <div class="grid tm-gallery">
                            <figure class="effect-bubba">
                                <img src="../Usercenter/img/img-11-08.jpg" alt="Image 8" class="img-fluid">
                                <figcaption>
                                    <h2>Light <span>Bridge</span></h2>
                                    <p>Fusce faucibus metus in augue</p>
                                    <a href="../Usercenter/img/img-11-08.jpg">View more</a>
                                </figcaption>
                            </figure>

                            <figure class="effect-bubba">
                                <img src="../Usercenter/img/img-11-07.jpg" alt="Image 7" class="img-fluid">
                                <figcaption>
                                    <h2>Glass <span>Tower</span></h2>
                                    <p>Sed ut ipsum eu purus ullamcorper</p>
                                    <a href="../Usercenter/img/img-11-07.jpg">View more</a>
                                </figcaption>
                            </figure>

                            <figure class="effect-bubba">
                                <img src="../Usercenter/img/img-11-05.jpg" alt="Image 5" class="img-fluid">
                                <figcaption>
                                    <h2>Jump <span>Higher</span></h2>
                                    <p>Morbi fermentum eget libero sed</p>
                                    <a href="../Usercenter/img/img-11-05.jpg">View more</a>
                                </figcaption>
                            </figure>

                            <figure class="effect-bubba">
                                <img src="../Usercenter/img/img-11-03.jpg" alt="Image 3" class="img-fluid">
                                <figcaption>
                                    <h2>Forest <span>Park</span></h2>
                                    <p>Aenean rutrum enim a tellus suscipit</p>
                                    <a href="../Usercenter/img/img-11-03.jpg">View more</a>
                                </figcaption>
                            </figure>

                            <figure class="effect-bubba">
                                <img src="../Usercenter/img/img-11-02.jpg" alt="Image 2" class="img-fluid">
                                <figcaption>
                                    <h2>Ice <span>Mountain</span></h2>
                                    <p>Curabitur a ipsum eget eros sodales</p>
                                    <a href="../Usercenter/img/img-11-02.jpg">View more</a>
                                </figcaption>
                            </figure>

                            <figure class="effect-bubba">
                                <img src="../Usercenter/img/img-11-04.jpg" alt="Image 4" class="img-fluid">
                                <figcaption>
                                    <h2>Green <span>Field</span></h2>
                                    <p>Duis eget tortor et mauris tempus</p>
                                    <a href="../Usercenter/img/img-11-04.jpg">View more</a>
                                </figcaption>
                            </figure>                                
                        </div>
                    </div>
                    ...
                    <div id="services" class="tm-content-box tm-gray-bg tm-services">
                        ...
                        <div class="tm-services-img-container">
                            <img src="../Usercenter/img/450x900-01.jpg" alt="Green Field" class="img-fluid tm-services-img">    
                        </div> 
        ...
        <script src="../Usercenter/js/jquery-1.11.3.min.js"></script>             <!-- jQuery (https://jquery.com/download/) -->
        <script src="../Usercenter/js/tether.min.js"></script> <!-- Tether for Bootstrap (http://stackoverflow.com/questions/34567939/how-to-fix-the-error-error-bootstrap-tooltips-require-tether-http-github-h) -->
        <script src="../Usercenter/js/jquery.magnific-popup.min.js"></script>     <!-- Magnific pop-up (http://dimsemenov.com/plugins/magnific-popup/) -->
        <script src="../Usercenter/js/jquery.singlePageNav.min.js"></script>      <!-- Single Page Nav (https://github.com/ChrisWojcik/single-page-nav) -->
        <script src="../Usercenter/js/usercenter.js"></script>
