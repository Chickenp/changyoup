...
=======
	pageEncoding="BIG5"%>
>>>>>>> 240716ddbfa62f90718b6cde85f7bae95983a92f
<!DOCTYPE html>
					...
					<div class="nav-header">
						...
						<nav id="fh5co-menu-wrap" role="navigation">
							<ul class="sf-menu" id="fh5co-primary-menu">
								...
								<li><a href="#" data-toggle="modal" data-target="#login-modal">User Center</a></li>
								<%
...
<link rel="stylesheet" type="text/css"
	href="/changyoup/changyoup/css/login.css">
					...
					<div class="row">
						<div class="col-md-4 col-sm-4 fh5co-item-wrap">
							<a class="fh5co-listing-item"> <img
								src="/changyoup/changyoup/images/img-1.jpg"
